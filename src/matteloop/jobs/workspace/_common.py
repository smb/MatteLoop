...
from matteloop.core.fingerprints import cut_cache_key_from_inputs
...
# Existing promoted cuts carry this persisted schema token. Retaining it keeps
# the rename from invalidating manifests or their authoritative cache keys.
